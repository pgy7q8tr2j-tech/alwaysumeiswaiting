...
const items = [
  ...
  { label: "メールアドレス",     value: "※Instagram DMにてお問い合わせください" },
  { label: "販売URL",            value: "https://alwaysumeiswaiting.vercel.app" },
  ...
  { label: "返品・キャンセル",   value: "予約金は理由の如何を問わず返金いたしません。商品（絵画・プリント）は商品の性質上、返品・交換はお受けできません。ただし、商品に明らかな欠陥がある場合はご連絡ください。" },
];
